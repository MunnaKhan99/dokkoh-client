...
//  <h2 className="text-lg font-bold text-slate-800 mb-1">কাজের অভিজ্ঞতা</h2>
//             <p className="text-slate-400 text-sm mb-4">
//                 আপনার মোট অভিজ্ঞতার সময়কাল নির্বাচন করুন
//             </p>
...
//                         key={item.id}
//                         onClick={() =>
//                             setProviderData({ ...providerData, experience: item.id })
//                         }
//                         className={`cursor-pointer border-2 rounded-xl py-4 px-2 text-center items-center transition-all ${providerData.experience === item.id
//                                 ? "border-emerald-500 bg-emerald-600 text-white shadow-lg shadow-emerald-200"
//                                 : "border-slate-100 text-slate-600 hover:border-slate-200"
//                             }`}
//                     >
